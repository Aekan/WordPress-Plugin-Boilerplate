...
* change `super_simple` to `example_me`
* change `plugin-name` to `example-me`
* change `Super_Simple` to `Example_Me`
* change `SUPER_SIMPLE_` to `EXAMPLE_ME_`
...
Note that previous versions of the Boilerplate did not include `Super_Simple_Loader` but this class is used to register all filters and actions with WordPress.
